...
mutable struct Optimizer <: MOI.AbstractOptimizer
    ...
    function Optimizer(verbose::Bool, max_iters::Int, time_limit::Float64, tol_rel_opt::Float64, tol_abs_opt::Float64, tol_feas::Float64)
        opt = new()
        opt.verbose = verbose
...
Optimizer(;
    ...
    ) = Optimizer( verbose, max_iters, time_limit, tol_rel_opt, tol_abs_opt, tol_feas)
...
# build outer approximation MOI model and list of cone objects
